...
//click(client);
    ...
    default void castSpell(WidgetInfo widgetInfo, Client client, PkToolsPlugin plugin) {
        try {
           ...
           //spell_widget.getTargetVerb(), spell_widget.getName(), 1, MenuAction.CC_OP.getId(), spell_widget.getItemId(), spell_widget.getId()));
            client.menuAction(spell_widget.getItemId(), spell_widget.getId(), MenuAction.CC_OP, 1, 0, spell_widget.getTargetVerb(), spell_widget.getName());
            //click(client);
        } catch (Exception e) {
            System.out.println(e.getMessage());
            e.printStackTrace();
    ...
    default void clickSpell(WidgetInfo widgetInfo, Client client, PkToolsPlugin plugin) {
        try {
            ...
            client.menuAction(spell_widget.getItemId(), spell_widget.getId(), MenuAction.WIDGET_TARGET, 0, 0, spell_widget.getTargetVerb(), spell_widget.getName());
...
class QuickPrayersCommand implements ScriptCommand {
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
            client.menuAction(-1, 10485775, MenuAction.CC_OP, 1, 0, "Activate", "Quick-prayers");
        } catch (Exception e) {
            System.out.println(e.getMessage());
            e.printStackTrace();
        }
...
class CrumbleUndeadCommand implements ScriptCommand {
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
            ...
            clickSpell(WidgetInfo.SPELL_CRUMBLE_UNDEAD, client, plugin);
        } catch (Exception e) {
            System.out.println(e.getMessage());
            e.printStackTrace();
        }
...
class SpecCommand implements ScriptCommand {
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
            ...
            //"Use <col=00ff00>Special Attack</col>", "", 1, MenuAction.CC_OP.getId(), -1, 38862884));
            client.menuAction(-1, 38862884, MenuAction.CC_OP,1,0, "Use <col=00ff00>Special Attack</col>", "");
            //click(client);
        } catch (Exception e) {
            System.out.println(e.getMessage());
            e.printStackTrace();
        ...
        try {
            ...
            for (WidgetItem item : utils.getAllInventoryItems()) {
                if (("Group 1").equalsIgnoreCase(getTag(configManager, item.getId()))) {
                    ...
                    utils.useItem(item, 3, MenuAction.CC_OP);
...
class ItemCommand implements ScriptCommand {
    ...
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
            ...
            utils.useItem(utils.getInventoryWidgetItem(itemId), 3, MenuAction.CC_OP);
...
/*class ItemCommand implements ScriptCommand {
    ...
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
            ...
            //utils.useItem(utils.getWidgetItem(itemId), 3, MenuAction.CC_OP);
...
class OpenInventoryWidget implements ScriptCommand{
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
           //invokeMenuAction("", "", 1, 57,  -1, 10747958));
            client.menuAction(-1, 10747958, MenuAction.of(1), 57, 0, "", "");
        } catch (Exception e){
            System.out.println(e.getMessage());
            e.printStackTrace();
        }
    ...
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
            if (plugin.lastEnemy != null) {
                client.menuAction(plugin.lastEnemy.getWorldLocation().getX(), plugin.lastEnemy.getWorldLocation().getX(), MenuAction.WALK, plugin.lastEnemy.getId(),0, "","");
...
class ClickEnemyCommand implements ScriptCommand {
    public void execute(Client client, PkToolsConfig config, PkToolsPlugin plugin, ConfigManager configManager) {
        try {
            MenuAction action;
            if (plugin.lastEnemy != null) {
               //"", "", plugin.lastEnemy.getPlayerId(), client.getSpellSelected() ? MenuAction.SPELL_CAST_ON_PLAYER.getId() : MenuAction.PLAYER_SECOND_OPTION.getId(), 0, 0));
               client.menuAction(0, 0, client.isWidgetSelected() ? MenuAction.WIDGET_TARGET_ON_PLAYER : MenuAction.PLAYER_SECOND_OPTION, plugin.lastEnemy.getId(),0, "","");
                //click(client);
            }
        } catch (Exception e) {
            System.out.println(e.getMessage());
