...
public class VorkathPlugin extends Plugin
{
    ...
    private void onGameTick(GameTick event)
    {
        ...
        if (client.getVar(Varbits.QUICK_PRAYER) != 1 && isAtVorkath() && config.autoQuickPrayers())
        {
